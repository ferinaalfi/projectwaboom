 ...
 *Polling Jurusan*
 ...
 9. Alfamart 
    `);
    } else if (msg.body === '1. Akuntansi' | '1' | 'Akuntansi' |'akuntansi'| '1. akuntansi') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');

    }
    else if (msg.body === '2. Perbankan' | '2' | 'Perbankan' |'perbankan'| '2. akuntansi') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '3. Pemasaran' | '3' | 'Pemasaran' |'pemasaran'| '3. pemasaran') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '4. Usaha Perjalanan Wisata' | '4' | 'Usaha Perjalanan Wisata' |'usaha perjalanan wisata'| '4. usaha perjalanan wisata') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '5. Administrasi perkantoran' | '5' | 'Administrasi perkantoran' |'administrasi perkantoran'| '4. administrasi perkantoran') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '6. Multimedia' | '6' | 'Multimedia' |'multimedia'| '6. multimedia') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '7. TKJ' | '7' | 'TKJ' |'tkj'| '7. tkj') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '8. Perhotelan' | '8' | 'Perhotelan' |'perhotelan'| '8. perhotelan') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
    ...
    else if (msg.body === '9. Alfamart' | '9' | 'Alfamart' |'alfamart'| '9. alfamart') {
        // Send a new message to the same chat
        // Kirim pesan baru ke obrolan yang sama
        client.sendMessage(msg.from, 'Silahkan Gabung Link Grup Dibawah Ini https://chat.whatsapp.com/Ip0WM02JZDJ7UZbjVlr60R');
